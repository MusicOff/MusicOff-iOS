...
- (void)viewDidLoad
{
    ...
    scrollView.contentSize = CGSizeMake(320 * 6, 410);
    scrollView.contentOffset = CGPointMake(320, 410);
    scrollView.backgroundColor = [UIColor clearColor];
    
    helpViewControllerFront = [[HelpViewController alloc] init];
    helpViewControllerFront.view.frame = CGRectMake(0, 0, 320, 410);
    homeViewController = [[HomeViewController alloc] init];
    homeViewController.view.frame = CGRectMake(320, 0, 320, 410);
    settingViewController = [[SettingViewController alloc] init];
    settingViewController.view.frame = CGRectMake(640, 0, 320, 410);
    musicOffViewController = [[MusicOffViewController alloc] init];
    musicOffViewController.view.frame = CGRectMake(960, 0, 320, 410);
    helpViewController = [[HelpViewController alloc] init];
    helpViewController.view.frame = CGRectMake(1280, 0, 320, 410);
    homeViewControllerBehind = [[HomeViewController alloc] init];
    homeViewControllerBehind.view.frame = CGRectMake(1600, 0, 320, 410);
    ...
    //Cover View
    UIView * cover = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 320, 480)];
...
- (void)setinitView
{
    tabBar = [[CustomTabBar alloc] initWithFrame:CGRectMake(0, 460 - CustomTabHeight, 320, CustomTabHeight)];
